"""
Copied and modified from UUTrack\Controller\devices\hamamatsu\hamamatsu_camera.py
"""
...
DCAM_IDPROP_SENSITIVITY= int("0x001F0110", 0)
...
class HamamatsuCamera():
    ...
    def startAcquisition(self):
        ...
        n_buffers = int(12.0*self.getPropertyValue("internal_frame_rate")[0])
